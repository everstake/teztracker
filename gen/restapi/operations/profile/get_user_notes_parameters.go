...
// NewGetUserNotesParams creates a new GetUserNotesParams object
// no default values defined in spec.
func NewGetUserNotesParams() GetUserNotesParams {

	return GetUserNotesParams{}
}

// GetUserNotesParams contains all the bound params for the get user notes operation
...
func (o *GetUserNotesParams) bindAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
