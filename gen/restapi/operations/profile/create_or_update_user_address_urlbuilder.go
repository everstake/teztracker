...
func (o *CreateOrUpdateUserAddressURL) WithBasePath(bp string) *CreateOrUpdateUserAddressURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateOrUpdateUserAddressURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/profile/address"
...
func (o *CreateOrUpdateUserAddressURL) String() string {
...
func (o *CreateOrUpdateUserAddressURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateOrUpdateUserAddressURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateOrUpdateUserAddressURL")
	}
