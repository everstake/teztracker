...
func (o *GetUserAddressesURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/profile/addresses"
...
func (o *GetUserAddressesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetUserAddressesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetUserAddressesURL")
	}
