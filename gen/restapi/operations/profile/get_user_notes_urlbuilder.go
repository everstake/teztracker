...
func (o *GetUserNotesURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/profile/notes"
...
func (o *GetUserNotesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetUserNotesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetUserNotesURL")
	}
