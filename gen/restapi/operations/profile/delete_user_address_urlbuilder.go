...
func (o *DeleteUserAddressURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/profile/delete/address"
...
func (o *DeleteUserAddressURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteUserAddressURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteUserAddressURL")
	}
