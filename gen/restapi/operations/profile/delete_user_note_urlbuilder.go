...
func (o *DeleteUserNoteURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/profile/delete/note"
...
func (o *DeleteUserNoteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteUserNoteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteUserNoteURL")
	}
