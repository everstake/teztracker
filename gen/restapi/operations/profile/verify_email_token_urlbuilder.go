...
func (o *VerifyEmailTokenURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/profile/verify/email/token"
...
func (o *VerifyEmailTokenURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on VerifyEmailTokenURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on VerifyEmailTokenURL")
	}
