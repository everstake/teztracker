...
// NewDeleteUserNoteParams creates a new DeleteUserNoteParams object
// no default values defined in spec.
func NewDeleteUserNoteParams() DeleteUserNoteParams {

	return DeleteUserNoteParams{}
}

// DeleteUserNoteParams contains all the bound params for the delete user note operation
...
func (o *DeleteUserNoteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.DeleteUserNote
...
func (o *DeleteUserNoteParams) bindAddress(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
