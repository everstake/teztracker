...
func (o *GetNFTContractsListURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{network}/nft_contracts"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetNFTContractsListURL")
	}
...
func (o *GetNFTContractsListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNFTContractsListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNFTContractsListURL")
	}
