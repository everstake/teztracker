...
// NewGetNFTContractOperationsParams creates a new GetNFTContractOperationsParams object
...
func NewGetNFTContractOperationsParams() GetNFTContractOperationsParams {
	...
	return GetNFTContractOperationsParams{
		Limit: &limitDefault,
...
// GetNFTContractOperationsParams contains all the bound params for the get n f t contract operations operation
...
func (o *GetNFTContractOperationsParams) bindContractID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetNFTContractOperationsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetNFTContractOperationsParams()
		return nil
	}
...
func (o *GetNFTContractOperationsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetNFTContractOperationsParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractOperationsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractOperationsParams) validateOffset(formats strfmt.Registry) error {
