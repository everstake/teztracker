...
// NewGetNFTContractTokensParams creates a new GetNFTContractTokensParams object
...
func NewGetNFTContractTokensParams() GetNFTContractTokensParams {
	...
	return GetNFTContractTokensParams{
		Limit: &limitDefault,
...
// GetNFTContractTokensParams contains all the bound params for the get n f t contract tokens operation
...
func (o *GetNFTContractTokensParams) bindContractID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetNFTContractTokensParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetNFTContractTokensParams()
		return nil
	}
...
func (o *GetNFTContractTokensParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetNFTContractTokensParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractTokensParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractTokensParams) validateOffset(formats strfmt.Registry) error {
