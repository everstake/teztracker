...
// NewGetNFTContractsListParams creates a new GetNFTContractsListParams object
...
func NewGetNFTContractsListParams() GetNFTContractsListParams {
	...
	return GetNFTContractsListParams{
		Limit: &limitDefault,
...
// GetNFTContractsListParams contains all the bound params for the get n f t contracts list operation
...
func (o *GetNFTContractsListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetNFTContractsListParams()
		return nil
	}
...
func (o *GetNFTContractsListParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetNFTContractsListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractsListParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractsListParams) validateOffset(formats strfmt.Registry) error {
