...
func (o *GetNFTContractTokensListURL) Build() (*url.URL, error) {
	...
	if contractID != "" {
		...
		return nil, errors.New("contractId is required on GetNFTContractTokensListURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetNFTContractTokensListURL")
	}
...
func (o *GetNFTContractTokensListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNFTContractTokensListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNFTContractTokensListURL")
	}
