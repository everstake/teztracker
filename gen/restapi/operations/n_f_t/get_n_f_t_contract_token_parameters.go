...
// NewGetNFTContractTokenParams creates a new GetNFTContractTokenParams object
...
func NewGetNFTContractTokenParams() GetNFTContractTokenParams {
	...
	return GetNFTContractTokenParams{
		Limit: &limitDefault,
...
// GetNFTContractTokenParams contains all the bound params for the get n f t contract token operation
...
func (o *GetNFTContractTokenParams) bindContractID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetNFTContractTokenParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetNFTContractTokenParams()
		return nil
	}
...
func (o *GetNFTContractTokenParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetNFTContractTokenParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractTokenParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractTokenParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetNFTContractTokenParams) bindTokenID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
