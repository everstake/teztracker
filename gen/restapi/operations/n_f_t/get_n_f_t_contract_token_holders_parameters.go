...
// NewGetNFTContractTokenHoldersParams creates a new GetNFTContractTokenHoldersParams object
...
func NewGetNFTContractTokenHoldersParams() GetNFTContractTokenHoldersParams {
	...
	return GetNFTContractTokenHoldersParams{
		Limit: &limitDefault,
...
// GetNFTContractTokenHoldersParams contains all the bound params for the get n f t contract token holders operation
...
func (o *GetNFTContractTokenHoldersParams) bindContractID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetNFTContractTokenHoldersParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetNFTContractTokenHoldersParams()
		return nil
	}
...
func (o *GetNFTContractTokenHoldersParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetNFTContractTokenHoldersParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractTokenHoldersParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetNFTContractTokenHoldersParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetNFTContractTokenHoldersParams) bindTokenID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
