...
func (o *GetNFTContractOwnershipURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{network}/nft_contracts/{contract_id}/ownership"

	contractID := o.ContractID
	if contractID != "" {
		_path = strings.Replace(_path, "{contract_id}", contractID, -1)
	} else {
		return nil, errors.New("contractId is required on GetNFTContractOwnershipURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetNFTContractOwnershipURL")
	}
...
func (o *GetNFTContractOwnershipURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetNFTContractOwnershipURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetNFTContractOwnershipURL")
	}
