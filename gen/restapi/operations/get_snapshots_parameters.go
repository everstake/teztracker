...
// NewGetSnapshotsParams creates a new GetSnapshotsParams object
...
// GetSnapshotsParams contains all the bound params for the get snapshots operation
...
func (o *GetSnapshotsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetSnapshotsParams()
		return nil
	}
...
func (o *GetSnapshotsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetSnapshotsParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSnapshotsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSnapshotsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetSnapshotsParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
