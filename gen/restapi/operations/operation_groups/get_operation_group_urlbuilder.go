...
func (o *GetOperationGroupURL) Build() (*url.URL, error) {
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetOperationGroupURL")
	}
	...
	if operationGroupID != "" {
		...
		return nil, errors.New("operationGroupId is required on GetOperationGroupURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetOperationGroupURL")
	}
...
func (o *GetOperationGroupURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetOperationGroupURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetOperationGroupURL")
	}
