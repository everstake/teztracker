...
func (o *GetLostEndorsermentsAggCountURL) WithBasePath(bp string) *GetLostEndorsermentsAggCountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetLostEndorsermentsAggCountURL) Build() (*url.URL, error) {
	var _result url.URL

	var _path = "/v2/data/{platform}/{network}/lost/endorsements/agg"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetLostEndorsermentsAggCountURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetLostEndorsermentsAggCountURL")
	}
...
func (o *GetLostEndorsermentsAggCountURL) String() string {
...
func (o *GetLostEndorsermentsAggCountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetLostEndorsermentsAggCountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetLostEndorsermentsAggCountURL")
	}
