...
func (o *GetBlocksHeadURL) Build() (*url.URL, error) {
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetBlocksHeadURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetBlocksHeadURL")
	}
...
func (o *GetBlocksHeadURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBlocksHeadURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBlocksHeadURL")
	}
