...
// NewGetAssetTokenInfoParams creates a new GetAssetTokenInfoParams object
...
func NewGetAssetTokenInfoParams() GetAssetTokenInfoParams {
	...
	return GetAssetTokenInfoParams{
		Limit: &limitDefault,
...
// GetAssetTokenInfoParams contains all the bound params for the get asset token info operation
...
func (o *GetAssetTokenInfoParams) bindAssetID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAssetTokenInfoParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAssetTokenInfoParams()
		return nil
	}
...
func (o *GetAssetTokenInfoParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAssetTokenInfoParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAssetTokenInfoParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAssetTokenInfoParams) validateOffset(formats strfmt.Registry) error {
