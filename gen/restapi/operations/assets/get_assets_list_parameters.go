...
// GetAssetsListParams contains all the bound params for the get assets list operation
...
func (o *GetAssetsListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAssetsListParams()
		return nil
	}
...
func (o *GetAssetsListParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAssetsListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAssetsListParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAssetsListParams) validateOffset(formats strfmt.Registry) error {
