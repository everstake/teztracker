...
func (o *GetBlocksPriorityChartInfoURL) WithBasePath(bp string) *GetBlocksPriorityChartInfoURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetBlocksPriorityChartInfoURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/charts/blocks_priority"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetBlocksPriorityChartInfoURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetBlocksPriorityChartInfoURL")
	}
...
func (o *GetBlocksPriorityChartInfoURL) String() string {
...
func (o *GetBlocksPriorityChartInfoURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBlocksPriorityChartInfoURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBlocksPriorityChartInfoURL")
	}
