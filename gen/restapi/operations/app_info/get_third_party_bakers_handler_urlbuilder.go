...
func (o *GetThirdPartyBakersHandlerURL) WithBasePath(bp string) *GetThirdPartyBakersHandlerURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetThirdPartyBakersHandlerURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/thirdparty/bakers"
...
func (o *GetThirdPartyBakersHandlerURL) String() string {
...
func (o *GetThirdPartyBakersHandlerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetThirdPartyBakersHandlerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetThirdPartyBakersHandlerURL")
	}
