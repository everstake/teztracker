...
// GetHealthCheckInfoParams contains all the bound params for the get health check info operation
...
func (o *GetHealthCheckInfoParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHealthCheckInfoParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHealthCheckInfoParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHealthCheckInfoParams) validatePlatform(formats strfmt.Registry) error {
