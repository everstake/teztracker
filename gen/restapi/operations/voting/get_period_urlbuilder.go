...
func (o *GetPeriodURL) Build() (*url.URL, error) {
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetPeriodURL")
	}
...
func (o *GetPeriodURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetPeriodURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetPeriodURL")
	}
