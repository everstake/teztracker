...
// NewGetAccountDelegatorsParams creates a new GetAccountDelegatorsParams object
...
func NewGetAccountDelegatorsParams() GetAccountDelegatorsParams {
	...
	return GetAccountDelegatorsParams{
		Limit: &limitDefault,
...
// GetAccountDelegatorsParams contains all the bound params for the get account delegators operation
...
func (o *GetAccountDelegatorsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountDelegatorsParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountDelegatorsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAccountDelegatorsParams()
		return nil
	}
...
func (o *GetAccountDelegatorsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAccountDelegatorsParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountDelegatorsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountDelegatorsParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetAccountDelegatorsParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
