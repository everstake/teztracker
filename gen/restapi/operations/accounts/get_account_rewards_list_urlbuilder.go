...
func (o *GetAccountRewardsListURL) WithBasePath(bp string) *GetAccountRewardsListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountRewardsListURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/accounts/rewards/{accountId}"

	accountID := o.AccountID
	if accountID != "" {
		_path = strings.Replace(_path, "{accountId}", accountID, -1)
	} else {
		return nil, errors.New("accountId is required on GetAccountRewardsListURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountRewardsListURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountRewardsListURL")
	}
...
func (o *GetAccountRewardsListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountRewardsListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountRewardsListURL")
	}
