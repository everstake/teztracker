...
func (fn GetBakersHoldingHandlerFunc) Handle(params GetBakersHoldingParams) middleware.Responder {
	return fn(params)
}
...
func NewGetBakersHolding(ctx *middleware.Context, handler GetBakersHoldingHandler) *GetBakersHolding {
	return &GetBakersHolding{Context: ctx, Handler: handler}
}
...
func (o *GetBakersHolding) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	...
	var Params = NewGetBakersHoldingParams()
