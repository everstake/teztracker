...
func (o *GetAccountReportURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/accounts/{accountId}/report"

	accountID := o.AccountID
	if accountID != "" {
		_path = strings.Replace(_path, "{accountId}", accountID, -1)
	} else {
		return nil, errors.New("accountId is required on GetAccountReportURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountReportURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountReportURL")
	}
...
func (o *GetAccountReportURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountReportURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountReportURL")
	}
