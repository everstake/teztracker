...
// NewGetAccountDelegatorsByCycleListParams creates a new GetAccountDelegatorsByCycleListParams object
...
func NewGetAccountDelegatorsByCycleListParams() GetAccountDelegatorsByCycleListParams {
	...
	return GetAccountDelegatorsByCycleListParams{
		Limit: &limitDefault,
...
// GetAccountDelegatorsByCycleListParams contains all the bound params for the get account delegators by cycle list operation
...
func (o *GetAccountDelegatorsByCycleListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountDelegatorsByCycleListParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountDelegatorsByCycleListParams) bindCycleID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountDelegatorsByCycleListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAccountDelegatorsByCycleListParams()
		return nil
	}
...
func (o *GetAccountDelegatorsByCycleListParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAccountDelegatorsByCycleListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountDelegatorsByCycleListParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountDelegatorsByCycleListParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetAccountDelegatorsByCycleListParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
