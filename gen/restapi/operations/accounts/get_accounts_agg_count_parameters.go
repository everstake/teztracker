...
// NewGetAccountsAggCountParams creates a new GetAccountsAggCountParams object
// no default values defined in spec.
func NewGetAccountsAggCountParams() GetAccountsAggCountParams {

	return GetAccountsAggCountParams{}
}

// GetAccountsAggCountParams contains all the bound params for the get accounts agg count operation
...
func (o *GetAccountsAggCountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountsAggCountParams) bindFrom(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAccountsAggCountParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountsAggCountParams) bindPeriod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAccountsAggCountParams) validatePeriod(formats strfmt.Registry) error {
...
func (o *GetAccountsAggCountParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountsAggCountParams) bindTo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
