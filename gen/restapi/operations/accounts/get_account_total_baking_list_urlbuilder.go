...
func (o *GetAccountTotalBakingListURL) WithBasePath(bp string) *GetAccountTotalBakingListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountTotalBakingListURL) Build() (*url.URL, error) {
	...
	if accountID != "" {
		...
		return nil, errors.New("accountId is required on GetAccountTotalBakingListURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountTotalBakingListURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountTotalBakingListURL")
	}
...
func (o *GetAccountTotalBakingListURL) String() string {
...
func (o *GetAccountTotalBakingListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountTotalBakingListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountTotalBakingListURL")
	}
