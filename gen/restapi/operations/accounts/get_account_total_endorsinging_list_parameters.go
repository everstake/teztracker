...
// NewGetAccountTotalEndorsingingListParams creates a new GetAccountTotalEndorsingingListParams object
// no default values defined in spec.
func NewGetAccountTotalEndorsingingListParams() GetAccountTotalEndorsingingListParams {

	return GetAccountTotalEndorsingingListParams{}
}

// GetAccountTotalEndorsingingListParams contains all the bound params for the get account total endorsinging list operation
...
func (o *GetAccountTotalEndorsingingListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountTotalEndorsingingListParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountTotalEndorsingingListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountTotalEndorsingingListParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
