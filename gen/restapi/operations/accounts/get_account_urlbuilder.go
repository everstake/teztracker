...
func (o *GetAccountURL) Build() (*url.URL, error) {
	...
	if accountID != "" {
		...
		return nil, errors.New("accountId is required on GetAccountURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountURL")
	}
