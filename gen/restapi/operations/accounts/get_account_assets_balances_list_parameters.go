...
// NewGetAccountAssetsBalancesListParams creates a new GetAccountAssetsBalancesListParams object
// no default values defined in spec.
func NewGetAccountAssetsBalancesListParams() GetAccountAssetsBalancesListParams {

	return GetAccountAssetsBalancesListParams{}
}

// GetAccountAssetsBalancesListParams contains all the bound params for the get account assets balances list operation
...
func (o *GetAccountAssetsBalancesListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountAssetsBalancesListParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountAssetsBalancesListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountAssetsBalancesListParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
