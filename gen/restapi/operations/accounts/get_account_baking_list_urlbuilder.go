...
func (o *GetAccountBakingListURL) WithBasePath(bp string) *GetAccountBakingListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountBakingListURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/accounts/baking/{accountId}"

	accountID := o.AccountID
	if accountID != "" {
		_path = strings.Replace(_path, "{accountId}", accountID, -1)
	} else {
		return nil, errors.New("accountId is required on GetAccountBakingListURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountBakingListURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountBakingListURL")
	}
...
func (o *GetAccountBakingListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountBakingListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountBakingListURL")
	}
