...
func (o *GetBakersStakeChangeURL) WithBasePath(bp string) *GetBakersStakeChangeURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetBakersStakeChangeURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/bakers/stake/change"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetBakersStakeChangeURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetBakersStakeChangeURL")
	}
...
func (o *GetBakersStakeChangeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBakersStakeChangeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBakersStakeChangeURL")
	}
