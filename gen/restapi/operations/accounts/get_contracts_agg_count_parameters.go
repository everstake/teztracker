...
// NewGetContractsAggCountParams creates a new GetContractsAggCountParams object
// no default values defined in spec.
func NewGetContractsAggCountParams() GetContractsAggCountParams {

	return GetContractsAggCountParams{}
}

// GetContractsAggCountParams contains all the bound params for the get contracts agg count operation
...
func (o *GetContractsAggCountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetContractsAggCountParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetContractsAggCountParams) bindPeriod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetContractsAggCountParams) validatePeriod(formats strfmt.Registry) error {
...
func (o *GetContractsAggCountParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetContractsAggCountParams) bindTo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
