...
func (o *GetActiveAccountsAggCountURL) WithBasePath(bp string) *GetActiveAccountsAggCountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetActiveAccountsAggCountURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/active/accounts/agg"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetActiveAccountsAggCountURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetActiveAccountsAggCountURL")
	}
...
func (o *GetActiveAccountsAggCountURL) String() string {
...
func (o *GetActiveAccountsAggCountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetActiveAccountsAggCountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetActiveAccountsAggCountURL")
	}
