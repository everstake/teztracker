...
// NewGetBakersStakeChangeParams creates a new GetBakersStakeChangeParams object
// no default values defined in spec.
func NewGetBakersStakeChangeParams() GetBakersStakeChangeParams {

	return GetBakersStakeChangeParams{}
}

// GetBakersStakeChangeParams contains all the bound params for the get bakers stake change operation
...
func (o *GetBakersStakeChangeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetBakersStakeChangeParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetBakersStakeChangeParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
