...
type GetWhaleTranfersOK struct {
	...
	/*
	  In: Body
	*/
	Payload []*models.LargeTransfer `json:"body,omitempty"`
}
...
func (o *GetWhaleTranfersOK) WithPayload(payload []*models.LargeTransfer) *GetWhaleTranfersOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get whale tranfers o k response
func (o *GetWhaleTranfersOK) SetPayload(payload []*models.LargeTransfer) {
	o.Payload = payload
}
...
func (o *GetWhaleTranfersOK) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
	...
	if payload == nil {
		// return empty array
		payload = make([]*models.LargeTransfer, 0, 50)
	}
