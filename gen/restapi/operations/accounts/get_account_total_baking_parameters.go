...
// NewGetAccountTotalBakingParams creates a new GetAccountTotalBakingParams object
// no default values defined in spec.
func NewGetAccountTotalBakingParams() GetAccountTotalBakingParams {

	return GetAccountTotalBakingParams{}
}

// GetAccountTotalBakingParams contains all the bound params for the get account total baking operation
...
func (o *GetAccountTotalBakingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountTotalBakingParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountTotalBakingParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountTotalBakingParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
