...
func (o *GetAccountEndorsingListURL) WithBasePath(bp string) *GetAccountEndorsingListURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountEndorsingListURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/accounts/endorsing/{accountId}"

	accountID := o.AccountID
	if accountID != "" {
		_path = strings.Replace(_path, "{accountId}", accountID, -1)
	} else {
		return nil, errors.New("accountId is required on GetAccountEndorsingListURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountEndorsingListURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountEndorsingListURL")
	}
...
func (o *GetAccountEndorsingListURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountEndorsingListURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountEndorsingListURL")
	}
