...
// NewGetAccountFutureEndorsingParams creates a new GetAccountFutureEndorsingParams object
// no default values defined in spec.
func NewGetAccountFutureEndorsingParams() GetAccountFutureEndorsingParams {

	return GetAccountFutureEndorsingParams{}
}

// GetAccountFutureEndorsingParams contains all the bound params for the get account future endorsing operation
...
func (o *GetAccountFutureEndorsingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountFutureEndorsingParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountFutureEndorsingParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountFutureEndorsingParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
