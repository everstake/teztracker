...
// NewGetAccountsTotalAggCountParams creates a new GetAccountsTotalAggCountParams object
// no default values defined in spec.
func NewGetAccountsTotalAggCountParams() GetAccountsTotalAggCountParams {

	return GetAccountsTotalAggCountParams{}
}

// GetAccountsTotalAggCountParams contains all the bound params for the get accounts total agg count operation
...
func (o *GetAccountsTotalAggCountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountsTotalAggCountParams) bindFrom(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAccountsTotalAggCountParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountsTotalAggCountParams) bindPeriod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetAccountsTotalAggCountParams) validatePeriod(formats strfmt.Registry) error {
...
func (o *GetAccountsTotalAggCountParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountsTotalAggCountParams) bindTo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
