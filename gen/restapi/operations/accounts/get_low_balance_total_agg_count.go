...
func (fn GetLowBalanceTotalAggCountHandlerFunc) Handle(params GetLowBalanceTotalAggCountParams) middleware.Responder {
	return fn(params)
}
...
func NewGetLowBalanceTotalAggCount(ctx *middleware.Context, handler GetLowBalanceTotalAggCountHandler) *GetLowBalanceTotalAggCount {
	return &GetLowBalanceTotalAggCount{Context: ctx, Handler: handler}
}
...
func (o *GetLowBalanceTotalAggCount) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewGetLowBalanceTotalAggCountParams()
