...
// NewGetActiveAccountsAggCountParams creates a new GetActiveAccountsAggCountParams object
// no default values defined in spec.
func NewGetActiveAccountsAggCountParams() GetActiveAccountsAggCountParams {

	return GetActiveAccountsAggCountParams{}
}

// GetActiveAccountsAggCountParams contains all the bound params for the get active accounts agg count operation
...
func (o *GetActiveAccountsAggCountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetActiveAccountsAggCountParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetActiveAccountsAggCountParams) bindPeriod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetActiveAccountsAggCountParams) validatePeriod(formats strfmt.Registry) error {
...
func (o *GetActiveAccountsAggCountParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
