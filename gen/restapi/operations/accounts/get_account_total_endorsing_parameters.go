...
// NewGetAccountTotalEndorsingParams creates a new GetAccountTotalEndorsingParams object
// no default values defined in spec.
func NewGetAccountTotalEndorsingParams() GetAccountTotalEndorsingParams {

	return GetAccountTotalEndorsingParams{}
}

// GetAccountTotalEndorsingParams contains all the bound params for the get account total endorsing operation
...
func (o *GetAccountTotalEndorsingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountTotalEndorsingParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountTotalEndorsingParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountTotalEndorsingParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
