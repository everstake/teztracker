...
func (o *GetContractsAggCountURL) WithBasePath(bp string) *GetContractsAggCountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetContractsAggCountURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/contracts/agg"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetContractsAggCountURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetContractsAggCountURL")
	}
...
func (o *GetContractsAggCountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetContractsAggCountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetContractsAggCountURL")
	}
