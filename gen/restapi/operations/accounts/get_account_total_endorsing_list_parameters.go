...
// NewGetAccountTotalEndorsingListParams creates a new GetAccountTotalEndorsingListParams object
// no default values defined in spec.
func NewGetAccountTotalEndorsingListParams() GetAccountTotalEndorsingListParams {

	return GetAccountTotalEndorsingListParams{}
}

// GetAccountTotalEndorsingListParams contains all the bound params for the get account total endorsing list operation
...
func (o *GetAccountTotalEndorsingListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountTotalEndorsingListParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountTotalEndorsingListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountTotalEndorsingListParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
