...
func (o *GetAccountsAggCountURL) WithBasePath(bp string) *GetAccountsAggCountURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountsAggCountURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/accounts/agg"

	network := o.Network
	if network != "" {
		_path = strings.Replace(_path, "{network}", network, -1)
	} else {
		return nil, errors.New("network is required on GetAccountsAggCountURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountsAggCountURL")
	}
...
func (o *GetAccountsAggCountURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountsAggCountURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountsAggCountURL")
	}
