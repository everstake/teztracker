...
// NewGetAccountTotalBakingListParams creates a new GetAccountTotalBakingListParams object
// no default values defined in spec.
func NewGetAccountTotalBakingListParams() GetAccountTotalBakingListParams {

	return GetAccountTotalBakingListParams{}
}

// GetAccountTotalBakingListParams contains all the bound params for the get account total baking list operation
...
func (o *GetAccountTotalBakingListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountTotalBakingListParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountTotalBakingListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountTotalBakingListParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
