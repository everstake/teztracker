...
// NewGetAccountBakingListParams creates a new GetAccountBakingListParams object
...
func NewGetAccountBakingListParams() GetAccountBakingListParams {
	...
	return GetAccountBakingListParams{
		Limit: &limitDefault,
...
// GetAccountBakingListParams contains all the bound params for the get account baking list operation
...
func (o *GetAccountBakingListParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountBakingListParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountBakingListParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetAccountBakingListParams()
		return nil
	}
...
func (o *GetAccountBakingListParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetAccountBakingListParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountBakingListParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountBakingListParams) validateOffset(formats strfmt.Registry) error {
...
func (o *GetAccountBakingListParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
