...
func (o *GetAccountFutureEndorsingURL) WithBasePath(bp string) *GetAccountFutureEndorsingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountFutureEndorsingURL) Build() (*url.URL, error) {
	...
	var _path = "/v2/data/{platform}/{network}/accounts/endorsing/{accountId}/future"

	accountID := o.AccountID
	if accountID != "" {
		_path = strings.Replace(_path, "{accountId}", accountID, -1)
	} else {
		return nil, errors.New("accountId is required on GetAccountFutureEndorsingURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountFutureEndorsingURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountFutureEndorsingURL")
	}
...
func (o *GetAccountFutureEndorsingURL) String() string {
...
func (o *GetAccountFutureEndorsingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountFutureEndorsingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountFutureEndorsingURL")
	}
