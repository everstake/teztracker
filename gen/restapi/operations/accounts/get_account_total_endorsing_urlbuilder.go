...
func (o *GetAccountTotalEndorsingURL) WithBasePath(bp string) *GetAccountTotalEndorsingURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetAccountTotalEndorsingURL) Build() (*url.URL, error) {
	...
	if accountID != "" {
		...
		return nil, errors.New("accountId is required on GetAccountTotalEndorsingURL")
	}
	...
	if network != "" {
		...
		return nil, errors.New("network is required on GetAccountTotalEndorsingURL")
	}
	...
	if platform != "" {
		...
		return nil, errors.New("platform is required on GetAccountTotalEndorsingURL")
	}
...
func (o *GetAccountTotalEndorsingURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetAccountTotalEndorsingURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetAccountTotalEndorsingURL")
	}
