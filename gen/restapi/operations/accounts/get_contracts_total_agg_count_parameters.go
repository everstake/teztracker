...
// NewGetContractsTotalAggCountParams creates a new GetContractsTotalAggCountParams object
// no default values defined in spec.
func NewGetContractsTotalAggCountParams() GetContractsTotalAggCountParams {

	return GetContractsTotalAggCountParams{}
}

// GetContractsTotalAggCountParams contains all the bound params for the get contracts total agg count operation
...
func (o *GetContractsTotalAggCountParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetContractsTotalAggCountParams) bindFrom(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetContractsTotalAggCountParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetContractsTotalAggCountParams) bindPeriod(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetContractsTotalAggCountParams) validatePeriod(formats strfmt.Registry) error {
...
func (o *GetContractsTotalAggCountParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetContractsTotalAggCountParams) bindTo(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
