...
// NewGetAccountFutureBakingParams creates a new GetAccountFutureBakingParams object
// no default values defined in spec.
func NewGetAccountFutureBakingParams() GetAccountFutureBakingParams {

	return GetAccountFutureBakingParams{}
}

// GetAccountFutureBakingParams contains all the bound params for the get account future baking operation
...
func (o *GetAccountFutureBakingParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAccountFutureBakingParams) bindAccountID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAccountFutureBakingParams) bindNetwork(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAccountFutureBakingParams) bindPlatform(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
